<template>
	<div class="foot-btn" >
	  <ul>
		<router-link tag="li" to="/home" class="home" active-class="active"><a href="javascrpt:;" ></a></router-link>
		<router-link tag="li" to="/shopcar" class="write"><a href="javascrpt:;" ></a></router-link>
		<router-link tag="li" to="/user" class="my" active-class="active"><a href="javascrpt:;" ></a></router-link>
	  </ul>
	</div>
</template>
...
.foot-btn ul li.active a{height:0.5rem; border-bottom:0.1rem solid #5477b2; color:#5477b2;}
</style>
